...
$(function () {
  ...
  $('.selected>span').click(function(){
    let path=$(this).prev('img').attr('src');
    $('#mediumImg').attr('src',path);
    $('#icon_list>li>img').attr('src',path);
    var title1=$(this).prev('img').attr('title1');
    var title2=$(this).prev('img').attr('title2');
    $('#headerTit>span').replaceWith('<span>'+title1+'</span>')

    $('#headerTit>b').replaceWith('<b>'+title2+'</b>')
    // console.log($('#headerTit>b').text())
  })
  showhide()
  hoverSubMenu()
  search()
